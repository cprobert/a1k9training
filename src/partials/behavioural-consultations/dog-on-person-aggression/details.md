...
These consultations are always held at A1K9 Behaviour and Training Academy, never at your home: working with an aggressive dog at home is too dangerous.
...
If it's urgent, ringing <a href="tel:{{config.business.telephone}}" class="font-medium text-brand-700 underline underline-offset-4 hover:text-brand-800">{{config.business.telephoneDisplay}}</a> is quicker than waiting for a reply.
